...
// Temp flag aliases
// Shared by the Elite Four and Champion's rooms in the Pokémon League
#define FLAG_TEMP_ENABLE_LEAGUE_LIGHTING        FLAG_TEMP_2
#define FLAG_TEMP_READY_DISABLE_LEAGUE_LIGHTING FLAG_TEMP_3
#define FLAG_TEMP_DISABLE_LEAGUE_LIGHTING       FLAG_TEMP_4
#define FLAG_TEMP_PAUSE_LEAGUE_LIGHTING         FLAG_TEMP_5

// Shared by the challenge floors and roof of the Trainer Tower
#define FLAG_TEMP_HIDE_TOWER_TRAINER_DOUBLES1 FLAG_TEMP_2
#define FLAG_TEMP_HIDE_TOWER_TRAINER_SINGLES  FLAG_TEMP_3
#define FLAG_TEMP_HIDE_TOWER_TRAINER_KNOCKOUT FLAG_TEMP_4
#define FLAG_TEMP_HIDE_TOWER_TRAINER_DOUBLES2 FLAG_TEMP_5
#define FLAG_TEMP_HIDE_TOWER_OWNER            FLAG_TEMP_6
